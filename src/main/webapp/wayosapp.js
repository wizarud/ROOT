class WayOS {
	...
	initWebSocket() {
	    ...
	    websocket.onmessage = function (message) {
			...
			if (messageArray.length==1 && messageArray[0].type==='begin') {
				
				console.log("Begin: " + messageArray[0].text);
				//Clear Screen
				this.parentElement.frameUX.setInnerHTML("");
	...
	*/
	...
	animateJumpingText(text, next) {
		...
		this.setText(innerHTML, function (frame) {
				...
				this.parentElement.play(this.parentElement.wayOS.ringURL);
