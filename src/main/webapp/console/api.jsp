...
function generateApiPath() {
	...
	$("#curl").val('curl -d "&message=Hello&sessionId='+ timestamp +'" -X POST '+ domain + contextRoot +'/webhooks/'+ contextName(botId) +' -H "Content-Type: application/x-www-form-urlencoded; charset=UTF-8"');
