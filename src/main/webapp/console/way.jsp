                        		...
                        		<div id="service-content" class="content">
						        	<div id="chat_widget_input_container">
						            	<form method="post" id="chat_widget_form">
						                	<textarea class="form-control" id="chat_widget_input" style="font-size: medium; font-weight: bold" rows="100" cols="88"></textarea>
						                	<br>
...
function loadWay() {
	...
	let url = contextRoot + "/console/csv/" + contextName(botId) + "?type=way.txt";
...
$("#chat_widget_button").click(function () {
	...
	let file = new File([content], contextName(botId) + "/way.txt", {
		  type: "text/plain",
	});	
